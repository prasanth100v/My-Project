...
```
 * Generate Password `copy` and `paste`
...
```
   * 9090 port is must after prometheus loadbalancer DNS name
...
```
 * Select: `Prometheus`
 * URL: `http://a82f2aa6acee9464aa6d7e061a1ffcc1-1209216230.ap-south-1.elb.amazonaws.com:9090`
 * Click: `Save & Test`
