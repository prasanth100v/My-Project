...
For deployment, I follow a GitOps-style approach by dynamically updating Kubernetes manifests with the new image tag and deploying the application to Amazon EKS. Authentication is handled securely using OIDC, eliminating the need for long-lived AWS credentials.
